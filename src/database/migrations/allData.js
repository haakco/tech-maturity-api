      ...
      capabilities: [
        {
          ...
          levels: [
            ...
            {
              level: 3,
              value: '50%+ code coverage is maintained',
            },
            {
              level: 4,
              value: '65%+ code coverage is maintained or less than 20% of build rejections by regression test coverage',
            },
          ],
        },
        {
        ...
        {
          name: 'There is a separate environment where developers can test their code from where non-developer testing happens',
          description: '',
          minimum_category_capability_level_id: 4,
          tools: 'There is a separate environment where developers can test their code from where non-developer testing happens',
          levels: [
            {
              level: 1,
              value: 'Only Pre',
      ...
      capabilities: [
        ...
        },
        {
          ...
          levels: [
            ...
            {
              level: 2,
              value: 'Automated deployment and manual testing are performed in staging',
            },
            {
              level: 3,
      ...
      capabilities: [
        ...
        },
        {
          ...
          levels: [
            ...
            {
              level: 2,
              value: 'Dedicate BU resident(local in country and not developer), fulfilling OPS responsibility ',
            },
            {
              level: 3,
            ...
            {
              level: 4,
              value: 'Identified OPS team (3+) in BU having business context outside their BU',
            },
          ],
        },
        {
          ...
          levels: [
            ...
            {
              level: 3,
              value: '50% monitoring coverage and understanding alerts and action required. SLA\'s defined and resident OPS (in BU) able to act (24/7) on alerts ',
            },
            {
              level: 4,
              value: '65% monitoring coverage and understanding alerts and action required. SLA\'s defined and resident OPS (in BU) able to act (24/7) on alerts',
            },
          ],
        },
        {
        ...
        },
        {
          ...
          levels: [
            ...
            {
              level: 3,
              value: 'There is an established disaster recovery plan (DRP) and business able to recover systems from play books',
            },
            {
              level: 4,
      ...
      capabilities: [
        ...
        },
        {
          ...
          levels: [
            ...
            {
              level: 2,
              value: 'Contributors can track debt via a defined process (Road map)',
            },
            {
              level: 3,
